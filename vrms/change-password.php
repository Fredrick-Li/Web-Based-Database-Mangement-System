...
if (strlen($_SESSION['vrmsuid']==0)) {
  header('location:logout.php');
    ...
    if(isset($_POST['submit'])){
        ...
        $msg= "Your password has been successully changed"; 
    } 
    else {
        $msg="Wrong Password";
    }
...
<!-- Several functions to check the operation integrity. -->


function checkpass(){
    if(document.changepassword.newpassword.value!=document.changepassword.confirmpassword.value)
        {
        alert('New Password and Confirmed Password do not not match');
