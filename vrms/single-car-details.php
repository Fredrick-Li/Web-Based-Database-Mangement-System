...
if(isset($_POST['submit']))
  {
    $userid=mysqli_real_escape_string($con, $_SESSION['vrmsuid']);
    $fullname=mysqli_real_escape_string($con, $_POST['fullname']);
    $email=mysqli_real_escape_string($con, $_POST['email']);
    $mobilenumber=mysqli_real_escape_string($con, $_POST['mobnum']);
    $location=mysqli_real_escape_string($con, $_POST['location']);
    $bdate=mysqli_real_escape_string($con, $_POST['bookingdate']);
    $rdate=mysqli_real_escape_string($con, $_POST['returndate']);
    $vid=mysqli_real_escape_string($con, $_GET['viewid']);
    ...
    if($num==0){
        ...
        if ($query1) {
            echo '<script>alert("Your vehicle hsa been booked successfully . Your Booking number is "+"'.$bookingnumber.'")</script>';
